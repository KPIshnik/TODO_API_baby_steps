...
<head>
  ...
  <title>TODO API baby steps</title>
          ...
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Default"><a href="#api-Default">API Methods - Default</a></li>
                    <li data-group="Default" data-name="loginDelete" class="">
                      <a href="#api-Default-loginDelete">loginDelete</a>
                    </li>
                    ...
                    <li data-group="Default" data-name="rootGet" class="">
                      <a href="#api-Default-rootGet">rootGet</a>
                    </li>
          </ul>
        </nav>
      </div>
        ...
        <div id="header">
          <div id="api-_">
            <h2 id="welcome-to-apidoc">API and SDK Documentation</h2>
              <div class="app-desc"><h2>GitHub repository: <a href="https://github.com/KPIshnik/TODO_API_baby_steps">https://github.com/KPIshnik/TODO_API_baby_steps</a></h2> </div>
            <hr>
            <div>basic email/pass authorization part (TOR 1.3)</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Default">
                  <h1>Default</h1>
                    <div id="api-Default-loginDelete">
                      <article id="api-Default-loginDelete-0" data-group="User" data-name="loginDelete" data-version="0">
                        <div class="pull-left">
                          <h1>loginDelete</h1>
                          <p>logout user</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">logout user and redirect to &quot;/login&quot;</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/login</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-loginDelete-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-loginDelete-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-loginDelete-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-loginDelete-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-loginDelete-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-loginDelete-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-loginDelete-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-loginDelete-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-loginDelete-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-loginDelete-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-loginDelete-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-loginDelete-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "http://localhost/login"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-loginDelete-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;

import io.swagger.client.auth._;
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            apiInstance.loginDelete();
        } catch (ApiException e) {
            System.err.println("Exception when calling DefaultApi#loginDelete");
            e.printStackTrace();
        }
    }
                          ...
                          <div class="tab-pane" id="examples-Default-loginDelete-0-android">
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-loginDelete-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->

                            <div class="tab-pane" id="examples-Default-loginDelete-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">

DefaultApi \*apiInstance = [[DefaultApi alloc] init];

// logout user
[apiInstance loginDeleteWithCompletionHandler:
^(NSError* error) {
if (error) {
NSLog(@"Error: %@", error);
}
                            ...
                            <div class="tab-pane" id="examples-Default-loginDelete-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TodoApiBabySteps = require('todo_api_baby_steps');

var api = new TodoApiBabySteps.DefaultApi()
...
api.loginDelete(callback);
</code></pre>
</div>

                            <!--<div class="tab-pane" id="examples-Default-loginDelete-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-loginDelete-0-csharp">
...
namespace Example
{
public class loginDeleteExample
{
public void main()
{
            ...
            {
                Debug.Print("Exception when calling DefaultApi.loginDelete: " + e.Message );
            }
        }
    }
                            ...
                            <div class="tab-pane" id="examples-Default-loginDelete-0-php">
...
try {
$api_instance->loginDelete();
} catch (Exception $e) {
echo 'Exception when calling DefaultApi->loginDelete: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
</div>

                            <div class="tab-pane" id="examples-Default-loginDelete-0-perl">
...
if ($@) {
warn "Exception when calling DefaultApi->loginDelete: $@\n";
}</code></pre>
</div>

                            <div class="tab-pane" id="examples-Default-loginDelete-0-python">
...
print("Exception when calling DefaultApi->loginDelete: %s\n" % e)</code></pre>
</div>
</div>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - Persons succesfully logedout. </h3>
                    ...
                    <div id="api-Default-loginPost">
                      <article id="api-Default-loginPost-0" data-group="User" data-name="loginPost" data-version="0">
                        <div class="pull-left">
                          <h1>loginPost</h1>
                          <p>login user by email</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">login user by email and password</p>
                        <p></p>
                        <br />
                        ...
                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-loginPost-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "http://localhost/login"</code></pre>
                          </div>
...
public class DefaultApiExample {
    ...
    public static void main(String[] args) {
        ...
        DefaultApi apiInstance = new DefaultApi();
        User user = ; // User | The person to create.
        try {
            apiInstance.loginPost(user);
        } catch (ApiException e) {
...
public class DefaultApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-Default-loginPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">User *user = ; // The person to create. (optional)

DefaultApi \*apiInstance = [[DefaultApi alloc] init];

// login user by email
[apiInstance loginPostWith:user
...
var opts = {
'user': // {User} The person to create.
};
...
public void main()
{
            ...
            var apiInstance = new DefaultApi();
            var user = new User(); // User | The person to create. (optional)
...
my $api_instance = WWW::SwaggerClient::DefaultApi->new();
my $user = WWW::SwaggerClient::Object::User->new(); # User | The person to create.

eval {
$api_instance->loginPost(user => $user);
};
if ($@) {
...
api_instance = swagger_client.DefaultApi()
user = # User | The person to create. (optional)

try: # login user by email
api_instance.login_post(user=user)
except ApiException as e:
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">user </td>
...
$(document).ready(function() {
  ...
  var result = $('#d2e199_loginPost_user');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_loginPost_user"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - user succesfully loginned. </h3>
                            ...
                            <h3> Status: 401 - access denied </h3>
                    ...
                    <div id="api-Default-registerPost">
                      <article id="api-Default-registerPost-0" data-group="User" data-name="registerPost" data-version="0">
                        <div class="pull-left">
                          <h1>registerPost</h1>
                          <p>register userr with email and password</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">register user with email and password</p>
                        <p></p>
                        <br />
                        ...
                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-registerPost-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "http://localhost/register"</code></pre>
                          </div>
...
public class DefaultApiExample {
  ...
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
                            ...
                            <div class="tab-pane" id="examples-Default-registerPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">User *user = ; // user data (optional)

DefaultApi \*apiInstance = [[DefaultApi alloc] init];

// register userr with email and password
[apiInstance registerPostWith:user
completionHandler: ^(NSError* error) {
if (error) {
NSLog(@"Error: %@", error);
}
...
public void main()
{
            ...
            var apiInstance = new DefaultApi();
            var user = new User(); // User | user data (optional)
...
try {
$api_instance->registerPost($user);
} catch (Exception $e) {
...
my $api_instance = WWW::SwaggerClient::DefaultApi->new();
my $user = WWW::SwaggerClient::Object::User->new(); # User | user data

eval {
$api_instance->registerPost(user => $user);
};
if ($@) {
...
api_instance = swagger_client.DefaultApi()
user = # User | user data (optional)

try: # register userr with email and password
api_instance.register_post(user=user)
except ApiException as e:
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_registerPost_user');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_registerPost_user"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - user ${username} registered </h3>
                            ...
                            <h3> Status: 400 - pass does not match || this email already registered, try anotherone </h3>
                      ...
                      <hr>
                    <div id="api-Default-rootGet">
                      <article id="api-Default-rootGet-0" data-group="User" data-name="rootGet" data-version="0">
                        <div class="pull-left">
                          <h1>rootGet</h1>
                          <p>greets you if authenticated or redirects to login</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Returns a list containing all persons.</p>
                        <p></p>
                        <br />
                        ...
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Default-rootGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Default-rootGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Default-rootGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Default-rootGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Default-rootGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Default-rootGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Default-rootGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Default-rootGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Default-rootGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Default-rootGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Default-rootGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Default-rootGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "http://localhost/"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Default-rootGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Default-rootGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.DefaultApi;
...
public class DefaultApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Default-rootGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->

                            <div class="tab-pane" id="examples-Default-rootGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">

DefaultApi \*apiInstance = [[DefaultApi alloc] init];

// greets you if authenticated or redirects to login
...
NSLog(@"Error: %@", error);
                            ...
                            <div class="tab-pane" id="examples-Default-rootGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TodoApiBabySteps = require('todo_api_baby_steps');
...
api.rootGet(callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Default-rootGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Default-rootGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
...
public void main()
{
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling DefaultApi.rootGet: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Default-rootGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Default-rootGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
...
warn "Exception when calling DefaultApi->rootGet: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Default-rootGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
...
try: # greets you if authenticated or redirects to login
...
print("Exception when calling DefaultApi->rootGet: %s\n" % e)</code></pre>
                          ...
                          <h2>Responses</h2>
                            ...
                            <h3> Status: 401 - Unauthorized.redirecting to login </h3>
